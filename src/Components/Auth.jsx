              ...
              <div className="container ">
                              <div className="d-flex align-items-center flex-column" style={{color:'white'}}>
                                       ...
                                       <center>
                                  {
                                      isRegisterForm ?
                                          <div>
                                              <Button className='btn btn-outline-light bg-transparent text-light mb-3 mt-2' style={{fontFamily:"inherit"}}  onClick={handleRegister} >Register</Button> <br />
                                      {/* <p style={{ color: 'white' }} >Already have an Account ? Click Here to <Link to={'/login'} style={{ textDecoration: 'none', color: "green" }}> Login </Link> </p> */}
                                       <p>Already have an account? Click here to   <a href="/login" style={{textDecoration:'none',color:"blueviolet",}}>Login</a></p>
                                          </div> :
                                          <div>
                                           <Button className='btn btn-outline-light bg-transparent text-light mb-3 mt-2 ' style={{fontFamily:"inherit"}}  onClick={handleLogin} >Login</Button> <br />
                                      {/* <p style={{color:'white' }} >New user ? Click Here to <Link to={'/register'} style={{textDecoration:'none',color:"red"}}> Register </Link> </p> */}
                                      <p>New user ? click here to   <a href="/register" style={{textDecoration:'none',color:'blueviolet'}}>Register</a></p>
                                       </div>
